...
params['region'] = regionDir + 'source_band3_2016_imfit_init.crtf'
params['outfile'] = regionDir + 'source_band3_2016_p5_imfit.crtf'
params['pbimage'] = imageDir + 'ngc40389overlap_band3_uvrange_robust_p5.pb'

statistic = {}
statistic['rms'] = 1.5e-5
statistic['pix/beam'] = 1.1331*0.087*0.074/0.015**2
