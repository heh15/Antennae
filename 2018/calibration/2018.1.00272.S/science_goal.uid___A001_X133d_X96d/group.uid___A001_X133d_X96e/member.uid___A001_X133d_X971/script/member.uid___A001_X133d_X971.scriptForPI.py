...
# $Id: scriptForPI.py,v 1.27 2019/02/13 09:02:35 dpetry Exp $
...
casalog.post('$Id: scriptForPI.py,v 1.27 2019/02/13 09:02:35 dpetry Exp $', 'INFO', 'scriptForPI')
...
for asdmname in scriptasdms + sdscriptasdms:
    ...
    if isAPP:
        os.system('tar -xf ../../calibration/*.tgz')
