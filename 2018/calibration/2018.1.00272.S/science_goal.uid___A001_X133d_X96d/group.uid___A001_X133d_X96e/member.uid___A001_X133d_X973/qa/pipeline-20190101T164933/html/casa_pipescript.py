...
context.set_state('ProjectStructure', 'ous_part_id', 'X457882766')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/dared.2018AUG/mnt/dataproc/2018.1.00272.S_2019_01_01T16_06_46.608/SOUS_uid___A001_X133d_X96d/GOUS_uid___A001_X133d_X96e/MOUS_uid___A001_X133d_X973/working/PPR_uid___A001_X133d_X974.xml')
...
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X133d/X973')
try:
    hifa_importdata(vis=['uid___A002_Xd3607d_X65a8', 'uid___A002_Xd3607d_X68a2', 'uid___A002_Xd395f6_X6bd0'], dbservice=False, session=['session_1', 'session_1', 'session_2'])
