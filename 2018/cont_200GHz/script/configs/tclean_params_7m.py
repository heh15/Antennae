...
par_tclean['vis'] = calDir+'ngc4038_band6_cont_7m.ms'
par_tclean['imagename'] = imageDir + 'ngc4038_band6_cont_7m'+testversions
par_tclean['phasecenter'] = 'J2000 12h01m53.1912 -18d52m29.7759'
par_tclean['specmode'] = 'mfs'
par_tclean['imsize'] = [240, 256]
par_tclean['outframe'] = 'Bary' # default
par_tclean['cell'] = '0.75arcsec'
