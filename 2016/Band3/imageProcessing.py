...
# smooth the band 3 robust 2 image to the beam size of 0.201 arcsec
imsmooth(imagename='ngc40389overlap_band3_uvrange_robust_2_smooth.image', 
        outfile='ngc40389overlap_band3_uvrange_robust_2_smooth_p201.image',
        major='0.201arcsec',
        minor='0.201arcsec',
        pa='0deg',
        targetres=True,
        overwrite=True)
impbcor(imagename='ngc40389overlap_band3_uvrange_robust_2_smooth_p201.image', pbimage='ngc40389overlap_band3_uvrange_robust_2.pb',
        outfile='ngc40389overlap_band3_uvrange_robust_2_smooth_p201.pbcor', overwrite=True)
